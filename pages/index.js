...
export default function Home({ pt, bannerData }) {
    ...
    <>
            ...
            <SwiperSlide key={ban._id}>
              <div className="relative">
                <img
                  src={ban.img}
                  alt="heor1"
                  className="w-full h-[40vh] sm:h-[50vh] md:h-[60vh] xl:h-[80vh] object-cover"
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-center p-10 bg-white-/20 backdrop-blur-sm border-2 border-white rounded-xl">
                  <h2 className="text-2xl md:text-4xl xl:text-6xl font-Cinzel font-semibold mb-5 text-black">
                    {ban.title}
                  </h2>
                  <span className="text-xl text-slate-500">{ban.subTitle}</span>
                </div>
              </div>
            </SwiperSlide>
          ))}
      ...
      <main>
        ...
        <div className="relative bg-[url('/img/bg/homeBg.png')] bg-no-repeat bg-center py-20">
          <div className="container grid gap-5 grid-cols-1 md:grid-cols-2 place-content-center text-center">
            <div className="text-left">
              <h2 className="text-2xl md:text-4xl font-Cinzel font-bold text-slate-900 mb-5 md:mb-10">
                Welcome to Wichita Falls Islamic Society
              </h2>
              <p className="text-md md:text-xl text-slate-700 w-4/5">
                The Wichita Falls Islamic Society is not just a mosque for
                prayers rather it is a community center for all. The Center is
            ...
            <div className="p-10 bg-slate-300/20 backdrop-blur-sm border-[1px] border-white rounded-sm w-full 2xl:w-2/3 mt-10 md:mt-0 2xl:ml-auto">
              <h2 className="text-xl md:text-4xl font-bold font-Cinzel text-slate-800">
                Prayer Times
              </h2>
              <p className="text-md md:text-xl text-slate-800">
                Prayer time in Texas
              </p>
              <span className="text-sm md:text-md text-slate-600">
                {formattedDate}
              </span>
        ...
        <div className="philosophy container py-10 text-center mb-20">
          <h2 className="text-4xl font-Cinzel font-bold text-slate-900 mb-20">
            Our Philosophy
          </h2>
          ...
          <div className="phis text-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-20">
            <div className="grid grid-cols-1">
              ...
              <h4 className="text-red-500 text-2xl font-Cinzel font-semibold mb-5">
                Knowledge
              </h4>
            ...
            <div className="grid grid-cols-1">
              ...
              <h4 className="text-emerald-500 text-2xl font-Cinzel font-semibold mb-5">
                Spirituality
              </h4>
              <p className="text-slate-600 text-xl">
            ...
            <div className="grid grid-cols-1">
              ...
              <h4 className="text-blue-500 text-2xl font-Cinzel font-semibold mb-5">
                Community
              </h4>
              <p className="text-slate-600 text-xl">
            ...
            <div className="grid grid-cols-1">
              ...
              <h4 className="text-green-500 text-2xl font-Cinzel font-semibold mb-5">
                Service
              </h4>
              <p className="text-slate-600 text-xl">
        ...
        <div className="donate relative">
          ...
          <div className="container">
            <div className="absolute top-1/2 md:right-1/4 -translate-y-1/2">
              <h2 className="text-xl md:text-4xl font-bold text-white font-Cinzel mb-5">
                Support us, <br /> we need your help.
              </h2>
              <p className="w-full md:w-[450px] text-gray-200 mb-5">
                May Allah bless you! Thank you. Those who (in charity) spend of
                their goods by night and by day, in secret and in public, have
        ...
        <div className="section relative py-20">
          <h2 className="text-4xl text-center font-Cinzel font-bold mb-20">
            Our Services
          </h2>
          ...
          <div className="container text-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20">
            <div className="grid grid-cols-1">
              ...
              <h4 className="text-sky-500 text-2xl font-Cinzel font-semibold mb-5">
                Shahada
              </h4>
              <p className="text-slate-600 text-xl">
        ...
        <div className="school relative">
          ...
          <div className="container">
            <div className="absolute top-1/2 md:right-1/4 -translate-y-1/2 md:w-1/3">
              ...
              <p className="w-full md:w-[450-px] text-gray-200 mb-5 text-md">
                The Weekend School of the Islamic Center of Allah is committed
                to providing quality Islamic Education according to the Quran
                and the Sunnah of the Prophet Mohammed (Peace Be upon Him) to a
...
export async function getStaticProps() {
  ...
  const res = await fetch(
    `http://api.aladhan.com/v1/calendar?latitude=33.965980&longitude=-98.518550&method=2&month=${
      month + 1
    }&year=${year}`
  );
