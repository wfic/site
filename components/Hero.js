    ...
    <div className="">
        ...
        <SwiperSlide>
            <div className="relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-center p-10 bg-white-/20 backdrop-blur-sm border-2 border-white rounded-xl">
                    <h2 className="text-3xl md:text-6xl font-Cinzel font-semibold mb-5 text-yellow-600">"And Allah Invites to the home of peace"</h2>
        ...
        <SwiperSlide>
            <div className="relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-center p-10 bg-white-/20 backdrop-blur-sm border-2 border-white rounded-xl">
                    <h2 className="text-3xl md:text-6xl font-Cinzel font-semibold mb-5 text-yellow-600">women qur'an class every friday night</h2>
        ...
        <SwiperSlide>
            <div className="relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-center p-10 bg-white-/20 backdrop-blur-sm border-2 border-white rounded-xl">
                    <h2 className="text-3xl md:text-6xl font-Cinzel font-semibold mb-5 text-yellow-600">Sirat Rasul allah every 2nd and 4th friday</h2>
        ...
        <SwiperSlide>
            <div className="relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] text-center p-10 bg-white-/20 backdrop-blur-sm border-2 border-white rounded-xl">
                    <h2 className="text-3xl md:text-6xl font-Cinzel font-semibold mb-5 text-yellow-600">Donate for our new mosque</h2>
                    <Link href="/donate">
