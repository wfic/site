        ...
        <footer className="relative text-center bg-[url('/img/footer.webp')] bg-no-repeat bg-center">
            <div className="container md:flex md:justify-between py-10">
                <div className="footerMenu">
                    ...
                    <div>
                        <ul>
                            <li className="text-xl text-gray-100/80 font-light ">
                                <Link href="/">
                                    Home
                                </Link>
                            </li>
                ...
                <div className="footerServices">
                    ...
                    <ul className="">
                        <li className="text-xl text-gray-100/80 font-light ">Marrige</li>
                        <li className="text-xl text-gray-100/80 font-light ">Funeral</li>
                        <li className="text-xl text-gray-100/80 font-light ">Scholarship</li>
                        <li className="text-xl text-gray-100/80 font-light ">Shahada</li>
                        <li className="text-xl text-gray-100/80 font-light ">Community</li>
                        <li className="text-xl text-gray-100/80 font-light ">Donate</li>
                    </ul>
                </div>
